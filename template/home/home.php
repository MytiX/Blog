...
<main class="container">
    ...
    <div class="row mb-2">
        <div class="col-md-6">
            <div class="row g-0 border-rounded flex-md-row mb-4 shadow-custom h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    <strong class="d-inline-block mb-2 text-primary">PHP</strong>
                    <h3 class="mb-0">Comprendre la ReflectionClass</h3>
        ...
        <div class="col-md-6">
            <div class="row g-0 border-rounded flex-md-row mb-4 shadow-custom h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    <strong class="d-inline-block mb-2 text-primary">GIT</strong>
                    <h3 class="mb-0">Est-ce-que GIT est un outil essentiel au développeur ?</h3>
                    <div class="mb-1 text-muted">Nov 11</div>
                    <p class="mb-auto">This is a wider card with supporting text below as a natural lead-in to
                        additional content.</p>
                    <!-- <a href="#" class="stretched-link">En lire +</a> -->
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-5">
        <div class="col-md-8">
            <h3 class="pb-4 mb-4 fst-italic border-bottom-custom">
                Les derniers articles
            </h3>

            <article class="blog-post border-bottom-custom">
                <a href="#" class="a-custom">
                    <h2 class="blog-post-title">Les langages de programmation les plus faciles à apprendre</h2>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto, obcaecati, sit quam a delectus consequatur nulla voluptates doloremque illo assumenda est. Reiciendis unde laborum, quam placeat hic itaque doloremque sed.</p>
                </a>
            ...
            <article class="blog-post border-bottom-custom">
                <a href="#" class="a-custom">
                    <h2 class="blog-post-title">Comment comprendre les subtilités de Symfony</h2>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto, obcaecati, sit quam a delectus consequatur nulla voluptates doloremque illo assumenda est. Reiciendis unde laborum, quam placeat hic itaque doloremque sed.</p>
                </a>
                <p class="blog-post-meta">January 1, 2021</p>
            </article>
            ...
            <article class="blog-post border-bottom-custom">
                <a href="#" class="a-custom">
                    <h2 class="blog-post-title">Les nouveautés de PHP 8.2</h2>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto, obcaecati, sit quam a delectus consequatur nulla voluptates doloremque illo assumenda est. Reiciendis unde laborum, quam placeat hic itaque doloremque sed.</p>
                </a>
                <p class="blog-post-meta">January 1, 2021</p>
            </article>
